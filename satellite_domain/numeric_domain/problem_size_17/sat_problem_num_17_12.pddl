...
(:init
	...
	(= (fuel satellite9) 129)
	(= (data Star17 thermograph3) 16)
	(= (data Star18 thermograph3) 201)
	(= (data Star17 spectrograph4) 258)
	(= (data Star18 spectrograph4) 295)
	(= (data Star17 infrared2) 273)
	(= (data Star18 infrared2) 193)
	(= (data Star17 image1) 281)
	(= (data Star18 image1) 52)
	(= (data Star17 thermograph0) 166)
	(= (data Star18 thermograph0) 136)
	...
	(= (slew_time Star18 Star0) 51.92)
	(= (slew_time Star0 Star18) 51.92)
	(= (slew_time Star18 GroundStation1) 1.551)
	(= (slew_time GroundStation1 Star18) 1.551)
	(= (slew_time Star18 Star2) 92.12)
	(= (slew_time Star2 Star18) 92.12)
	(= (slew_time Star18 GroundStation3) 44.6)
	(= (slew_time GroundStation3 Star18) 44.6)
	(= (slew_time Star18 GroundStation4) 16.16)
	(= (slew_time GroundStation4 Star18) 16.16)
	(= (slew_time Star18 Star5) 27)
	(= (slew_time Star5 Star18) 27)
	(= (slew_time Star18 Star6) 59.67)
	(= (slew_time Star6 Star18) 59.67)
	(= (slew_time Star18 Star7) 34.36)
	(= (slew_time Star7 Star18) 34.36)
	(= (slew_time Star18 GroundStation8) 35.21)
	(= (slew_time GroundStation8 Star18) 35.21)
	(= (slew_time Star18 GroundStation9) 36.94)
	(= (slew_time GroundStation9 Star18) 36.94)
	(= (slew_time Star18 GroundStation10) 23.52)
	(= (slew_time GroundStation10 Star18) 23.52)
	(= (slew_time Star18 GroundStation11) 19.26)
	(= (slew_time GroundStation11 Star18) 19.26)
	(= (slew_time Star18 GroundStation12) 5.777)
	(= (slew_time GroundStation12 Star18) 5.777)
	(= (slew_time Star18 GroundStation13) 31.28)
	(= (slew_time GroundStation13 Star18) 31.28)
	(= (slew_time Star18 Star14) 29.27)
	(= (slew_time Star14 Star18) 29.27)
	(= (slew_time Star18 GroundStation15) 17.5)
	(= (slew_time GroundStation15 Star18) 17.5)
	(= (slew_time Star18 Star16) 17.91)
	(= (slew_time Star16 Star18) 17.91)
	(= (slew_time Star18 Star17) 33.91)
	(= (slew_time Star17 Star18) 33.91)
	(= (data-stored) 0)
	(= (fuel-used) 0)
)
(:goal (and
