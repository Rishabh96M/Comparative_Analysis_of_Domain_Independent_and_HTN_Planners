...
(:init
	...
	(= (fuel satellite9) 104)
	(= (data Star14 thermograph4) 171)
	(= (data Phenomenon15 thermograph4) 258)
	(= (data Star14 infrared3) 114)
	(= (data Phenomenon15 infrared3) 65)
	(= (data Star14 thermograph2) 285)
	(= (data Phenomenon15 thermograph2) 122)
	(= (data Star14 thermograph0) 287)
	(= (data Phenomenon15 thermograph0) 193)
	(= (data Star14 thermograph1) 113)
	(= (data Phenomenon15 thermograph1) 291)
	...
	(= (slew_time Phenomenon15 GroundStation0) 49.36)
	(= (slew_time GroundStation0 Phenomenon15) 49.36)
	(= (slew_time Phenomenon15 Star1) 11.66)
	(= (slew_time Star1 Phenomenon15) 11.66)
	(= (slew_time Phenomenon15 GroundStation2) 32.03)
	(= (slew_time GroundStation2 Phenomenon15) 32.03)
	(= (slew_time Phenomenon15 GroundStation3) 31.57)
	(= (slew_time GroundStation3 Phenomenon15) 31.57)
	(= (slew_time Phenomenon15 Star4) 1.977)
	(= (slew_time Star4 Phenomenon15) 1.977)
	(= (slew_time Phenomenon15 GroundStation5) 0.5767)
	(= (slew_time GroundStation5 Phenomenon15) 0.5767)
	(= (slew_time Phenomenon15 Star6) 45.97)
	(= (slew_time Star6 Phenomenon15) 45.97)
	(= (slew_time Phenomenon15 GroundStation7) 62.58)
	(= (slew_time GroundStation7 Phenomenon15) 62.58)
	(= (slew_time Phenomenon15 GroundStation8) 49.04)
	(= (slew_time GroundStation8 Phenomenon15) 49.04)
	(= (slew_time Phenomenon15 Star9) 20.14)
	(= (slew_time Star9 Phenomenon15) 20.14)
	(= (slew_time Phenomenon15 GroundStation10) 37.33)
	(= (slew_time GroundStation10 Phenomenon15) 37.33)
	(= (slew_time Phenomenon15 GroundStation11) 48.94)
	(= (slew_time GroundStation11 Phenomenon15) 48.94)
	(= (slew_time Phenomenon15 GroundStation12) 2.962)
	(= (slew_time GroundStation12 Phenomenon15) 2.962)
	(= (slew_time Phenomenon15 GroundStation13) 24.06)
	(= (slew_time GroundStation13 Phenomenon15) 24.06)
	(= (slew_time Phenomenon15 Star14) 7.504)
	(= (slew_time Star14 Phenomenon15) 7.504)
	(= (data-stored) 0)
	(= (fuel-used) 0)
)
(:goal (and
