...
(:init
	...
	(= (fuel satellite9) 137)
	(= (data Star18 image3) 38)
	(= (data Star19 image3) 40)
	(= (data Star18 thermograph0) 125)
	(= (data Star19 thermograph0) 58)
	(= (data Star18 image1) 171)
	(= (data Star19 image1) 268)
	(= (data Star18 infrared2) 209)
	(= (data Star19 infrared2) 221)
	(= (data Star18 infrared4) 131)
	(= (data Star19 infrared4) 125)
	...
	(= (slew_time Star19 GroundStation0) 19.57)
	(= (slew_time GroundStation0 Star19) 19.57)
	(= (slew_time Star19 GroundStation1) 19.91)
	(= (slew_time GroundStation1 Star19) 19.91)
	(= (slew_time Star19 Star2) 6.847)
	(= (slew_time Star2 Star19) 6.847)
	(= (slew_time Star19 GroundStation3) 2.336)
	(= (slew_time GroundStation3 Star19) 2.336)
	(= (slew_time Star19 GroundStation4) 35.89)
	(= (slew_time GroundStation4 Star19) 35.89)
	(= (slew_time Star19 GroundStation5) 64.84)
	(= (slew_time GroundStation5 Star19) 64.84)
	(= (slew_time Star19 GroundStation6) 6.619)
	(= (slew_time GroundStation6 Star19) 6.619)
	(= (slew_time Star19 Star7) 41.71)
	(= (slew_time Star7 Star19) 41.71)
	(= (slew_time Star19 GroundStation8) 6.035)
	(= (slew_time GroundStation8 Star19) 6.035)
	(= (slew_time Star19 Star9) 67.35)
	(= (slew_time Star9 Star19) 67.35)
	(= (slew_time Star19 Star10) 47.02)
	(= (slew_time Star10 Star19) 47.02)
	(= (slew_time Star19 Star11) 34.01)
	(= (slew_time Star11 Star19) 34.01)
	(= (slew_time Star19 Star12) 20.3)
	(= (slew_time Star12 Star19) 20.3)
	(= (slew_time Star19 GroundStation13) 9.509)
	(= (slew_time GroundStation13 Star19) 9.509)
	(= (slew_time Star19 GroundStation14) 10.55)
	(= (slew_time GroundStation14 Star19) 10.55)
	(= (slew_time Star19 Star15) 49.33)
	(= (slew_time Star15 Star19) 49.33)
	(= (slew_time Star19 Star16) 31.88)
	(= (slew_time Star16 Star19) 31.88)
	(= (slew_time Star19 GroundStation17) 8.475)
	(= (slew_time GroundStation17 Star19) 8.475)
	(= (slew_time Star19 Star18) 52.8)
	(= (slew_time Star18 Star19) 52.8)
	(= (data-stored) 0)
	(= (fuel-used) 0)
)
(:goal (and
