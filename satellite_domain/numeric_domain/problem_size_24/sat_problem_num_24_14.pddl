...
(:init
	...
	(= (fuel satellite9) 183)
	(= (data Phenomenon24 infrared2) 107)
	(= (data Phenomenon25 infrared2) 10)
	(= (data Phenomenon24 image3) 152)
	(= (data Phenomenon25 image3) 94)
	(= (data Phenomenon24 thermograph0) 51)
	(= (data Phenomenon25 thermograph0) 77)
	(= (data Phenomenon24 image1) 6)
	(= (data Phenomenon25 image1) 300)
	(= (data Phenomenon24 infrared4) 277)
	(= (data Phenomenon25 infrared4) 164)
	...
	(= (slew_time GroundStation23 GroundStation0) 45.8)
	(= (slew_time GroundStation0 GroundStation23) 45.8)
	(= (slew_time GroundStation23 GroundStation1) 49.69)
	(= (slew_time GroundStation1 GroundStation23) 49.69)
	(= (slew_time GroundStation23 Star2) 0.3096)
	(= (slew_time Star2 GroundStation23) 0.3096)
	(= (slew_time GroundStation23 GroundStation3) 3.96)
	(= (slew_time GroundStation3 GroundStation23) 3.96)
	(= (slew_time GroundStation23 GroundStation4) 28.58)
	(= (slew_time GroundStation4 GroundStation23) 28.58)
	(= (slew_time GroundStation23 GroundStation5) 25.88)
	(= (slew_time GroundStation5 GroundStation23) 25.88)
	(= (slew_time GroundStation23 GroundStation6) 54.82)
	(= (slew_time GroundStation6 GroundStation23) 54.82)
	(= (slew_time GroundStation23 Star7) 31.65)
	(= (slew_time Star7 GroundStation23) 31.65)
	(= (slew_time GroundStation23 GroundStation8) 41.91)
	(= (slew_time GroundStation8 GroundStation23) 41.91)
	(= (slew_time GroundStation23 Star9) 3.089)
	(= (slew_time Star9 GroundStation23) 3.089)
	(= (slew_time GroundStation23 Star10) 8.624)
	(= (slew_time Star10 GroundStation23) 8.624)
	(= (slew_time GroundStation23 Star11) 25.81)
	(= (slew_time Star11 GroundStation23) 25.81)
	(= (slew_time GroundStation23 Star12) 27.19)
	(= (slew_time Star12 GroundStation23) 27.19)
	(= (slew_time GroundStation23 GroundStation13) 45.17)
	(= (slew_time GroundStation13 GroundStation23) 45.17)
	(= (slew_time GroundStation23 GroundStation14) 8.33)
	(= (slew_time GroundStation14 GroundStation23) 8.33)
	(= (slew_time GroundStation23 Star15) 66.71)
	(= (slew_time Star15 GroundStation23) 66.71)
	(= (slew_time GroundStation23 Star16) 35.74)
	(= (slew_time Star16 GroundStation23) 35.74)
	(= (slew_time GroundStation23 GroundStation17) 46.31)
	(= (slew_time GroundStation17 GroundStation23) 46.31)
	(= (slew_time GroundStation23 Star18) 28.71)
	(= (slew_time Star18 GroundStation23) 28.71)
	(= (slew_time GroundStation23 GroundStation19) 10.97)
	(= (slew_time GroundStation19 GroundStation23) 10.97)
	(= (slew_time GroundStation23 Star20) 13.05)
	(= (slew_time Star20 GroundStation23) 13.05)
	(= (slew_time GroundStation23 GroundStation21) 44.35)
	(= (slew_time GroundStation21 GroundStation23) 44.35)
	(= (slew_time GroundStation23 GroundStation22) 50.99)
	(= (slew_time GroundStation22 GroundStation23) 50.99)
	...
	(= (slew_time GroundStation22 GroundStation0) 30.02)
	(= (slew_time GroundStation0 GroundStation22) 30.02)
	(= (slew_time GroundStation22 GroundStation1) 25.26)
	(= (slew_time GroundStation1 GroundStation22) 25.26)
	(= (slew_time GroundStation22 Star2) 20.65)
	(= (slew_time Star2 GroundStation22) 20.65)
	(= (slew_time GroundStation22 GroundStation3) 28.8)
	(= (slew_time GroundStation3 GroundStation22) 28.8)
	(= (slew_time GroundStation22 GroundStation4) 10.6)
	(= (slew_time GroundStation4 GroundStation22) 10.6)
	(= (slew_time GroundStation22 GroundStation5) 2.259)
	(= (slew_time GroundStation5 GroundStation22) 2.259)
	(= (slew_time GroundStation22 GroundStation6) 58.22)
	(= (slew_time GroundStation6 GroundStation22) 58.22)
	(= (slew_time GroundStation22 Star7) 4.52)
	(= (slew_time Star7 GroundStation22) 4.52)
	(= (slew_time GroundStation22 GroundStation8) 11.76)
	(= (slew_time GroundStation8 GroundStation22) 11.76)
	(= (slew_time GroundStation22 Star9) 54.3)
	(= (slew_time Star9 GroundStation22) 54.3)
	(= (slew_time GroundStation22 Star10) 3.862)
	(= (slew_time Star10 GroundStation22) 3.862)
	(= (slew_time GroundStation22 Star11) 26.3)
	(= (slew_time Star11 GroundStation22) 26.3)
	(= (slew_time GroundStation22 Star12) 49.66)
	(= (slew_time Star12 GroundStation22) 49.66)
	(= (slew_time GroundStation22 GroundStation13) 0.5806)
	(= (slew_time GroundStation13 GroundStation22) 0.5806)
	(= (slew_time GroundStation22 GroundStation14) 12.56)
	(= (slew_time GroundStation14 GroundStation22) 12.56)
	(= (slew_time GroundStation22 Star15) 45.92)
	(= (slew_time Star15 GroundStation22) 45.92)
	(= (slew_time GroundStation22 Star16) 24.87)
	(= (slew_time Star16 GroundStation22) 24.87)
	(= (slew_time GroundStation22 GroundStation17) 2.3)
	(= (slew_time GroundStation17 GroundStation22) 2.3)
	(= (slew_time GroundStation22 Star18) 3.46)
	(= (slew_time Star18 GroundStation22) 3.46)
	(= (slew_time GroundStation22 GroundStation19) 24.19)
	(= (slew_time GroundStation19 GroundStation22) 24.19)
	(= (slew_time GroundStation22 Star20) 22.7)
	(= (slew_time Star20 GroundStation22) 22.7)
	(= (slew_time GroundStation22 GroundStation21) 41.28)
	(= (slew_time GroundStation21 GroundStation22) 41.28)
	...
	(= (slew_time Phenomenon24 GroundStation0) 7.094)
	(= (slew_time GroundStation0 Phenomenon24) 7.094)
	(= (slew_time Phenomenon24 GroundStation1) 13.43)
	(= (slew_time GroundStation1 Phenomenon24) 13.43)
	(= (slew_time Phenomenon24 Star2) 43.55)
	(= (slew_time Star2 Phenomenon24) 43.55)
	(= (slew_time Phenomenon24 GroundStation3) 37.83)
	(= (slew_time GroundStation3 Phenomenon24) 37.83)
	(= (slew_time Phenomenon24 GroundStation4) 34.85)
	(= (slew_time GroundStation4 Phenomenon24) 34.85)
	(= (slew_time Phenomenon24 GroundStation5) 24.1)
	(= (slew_time GroundStation5 Phenomenon24) 24.1)
	(= (slew_time Phenomenon24 GroundStation6) 13.21)
	(= (slew_time GroundStation6 Phenomenon24) 13.21)
	(= (slew_time Phenomenon24 Star7) 37.12)
	(= (slew_time Star7 Phenomenon24) 37.12)
	(= (slew_time Phenomenon24 GroundStation8) 1.996)
	(= (slew_time GroundStation8 Phenomenon24) 1.996)
	(= (slew_time Phenomenon24 Star9) 13.65)
	(= (slew_time Star9 Phenomenon24) 13.65)
	(= (slew_time Phenomenon24 Star10) 75.19)
	(= (slew_time Star10 Phenomenon24) 75.19)
	(= (slew_time Phenomenon24 Star11) 51.61)
	(= (slew_time Star11 Phenomenon24) 51.61)
	(= (slew_time Phenomenon24 Star12) 57.06)
	(= (slew_time Star12 Phenomenon24) 57.06)
	(= (slew_time Phenomenon24 GroundStation13) 19.67)
	(= (slew_time GroundStation13 Phenomenon24) 19.67)
	(= (slew_time Phenomenon24 GroundStation14) 65.76)
	(= (slew_time GroundStation14 Phenomenon24) 65.76)
	(= (slew_time Phenomenon24 Star15) 14.6)
	(= (slew_time Star15 Phenomenon24) 14.6)
	(= (slew_time Phenomenon24 Star16) 60.75)
	(= (slew_time Star16 Phenomenon24) 60.75)
	(= (slew_time Phenomenon24 GroundStation17) 77.7)
	(= (slew_time GroundStation17 Phenomenon24) 77.7)
	(= (slew_time Phenomenon24 Star18) 60.87)
	(= (slew_time Star18 Phenomenon24) 60.87)
	(= (slew_time Phenomenon24 GroundStation19) 3.878)
	(= (slew_time GroundStation19 Phenomenon24) 3.878)
	(= (slew_time Phenomenon24 Star20) 34.99)
	(= (slew_time Star20 Phenomenon24) 34.99)
	(= (slew_time Phenomenon24 GroundStation21) 25.32)
	(= (slew_time GroundStation21 Phenomenon24) 25.32)
	(= (slew_time Phenomenon24 GroundStation22) 53.96)
	(= (slew_time GroundStation22 Phenomenon24) 53.96)
	(= (slew_time Phenomenon24 GroundStation23) 54.45)
	(= (slew_time GroundStation23 Phenomenon24) 54.45)
	(= (slew_time Phenomenon25 GroundStation0) 4.864)
	(= (slew_time GroundStation0 Phenomenon25) 4.864)
	(= (slew_time Phenomenon25 GroundStation1) 46.67)
	(= (slew_time GroundStation1 Phenomenon25) 46.67)
	(= (slew_time Phenomenon25 Star2) 18.61)
	(= (slew_time Star2 Phenomenon25) 18.61)
	(= (slew_time Phenomenon25 GroundStation3) 38.72)
	(= (slew_time GroundStation3 Phenomenon25) 38.72)
	(= (slew_time Phenomenon25 GroundStation4) 72.37)
	(= (slew_time GroundStation4 Phenomenon25) 72.37)
	(= (slew_time Phenomenon25 GroundStation5) 21.69)
	(= (slew_time GroundStation5 Phenomenon25) 21.69)
	(= (slew_time Phenomenon25 GroundStation6) 25.4)
	(= (slew_time GroundStation6 Phenomenon25) 25.4)
	(= (slew_time Phenomenon25 Star7) 47.24)
	(= (slew_time Star7 Phenomenon25) 47.24)
	(= (slew_time Phenomenon25 GroundStation8) 0.6518)
	(= (slew_time GroundStation8 Phenomenon25) 0.6518)
	(= (slew_time Phenomenon25 Star9) 51.22)
	(= (slew_time Star9 Phenomenon25) 51.22)
	(= (slew_time Phenomenon25 Star10) 76.53)
	(= (slew_time Star10 Phenomenon25) 76.53)
	(= (slew_time Phenomenon25 Star11) 77.78)
	(= (slew_time Star11 Phenomenon25) 77.78)
	(= (slew_time Phenomenon25 Star12) 15.29)
	(= (slew_time Star12 Phenomenon25) 15.29)
	(= (slew_time Phenomenon25 GroundStation13) 49.07)
	(= (slew_time GroundStation13 Phenomenon25) 49.07)
	(= (slew_time Phenomenon25 GroundStation14) 17.29)
	(= (slew_time GroundStation14 Phenomenon25) 17.29)
	(= (slew_time Phenomenon25 Star15) 37.65)
	(= (slew_time Star15 Phenomenon25) 37.65)
	(= (slew_time Phenomenon25 Star16) 42.28)
	(= (slew_time Star16 Phenomenon25) 42.28)
	(= (slew_time Phenomenon25 GroundStation17) 77.32)
	(= (slew_time GroundStation17 Phenomenon25) 77.32)
	(= (slew_time Phenomenon25 Star18) 14.34)
	(= (slew_time Star18 Phenomenon25) 14.34)
	(= (slew_time Phenomenon25 GroundStation19) 21.68)
	(= (slew_time GroundStation19 Phenomenon25) 21.68)
	(= (slew_time Phenomenon25 Star20) 37.56)
	(= (slew_time Star20 Phenomenon25) 37.56)
	(= (slew_time Phenomenon25 GroundStation21) 29.72)
	(= (slew_time GroundStation21 Phenomenon25) 29.72)
	(= (slew_time Phenomenon25 GroundStation22) 69.34)
	(= (slew_time GroundStation22 Phenomenon25) 69.34)
	(= (slew_time Phenomenon25 GroundStation23) 68.14)
	(= (slew_time GroundStation23 Phenomenon25) 68.14)
	(= (slew_time Phenomenon25 Phenomenon24) 13.46)
	(= (slew_time Phenomenon24 Phenomenon25) 13.46)
	(= (data-stored) 0)
	(= (fuel-used) 0)
)
(:goal (and
