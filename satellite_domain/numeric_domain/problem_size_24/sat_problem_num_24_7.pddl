...
(:init
	...
	(= (fuel satellite9) 170)
	(= (data Phenomenon24 spectrograph2) 137)
	(= (data Phenomenon25 spectrograph2) 210)
	(= (data Phenomenon24 image0) 276)
	(= (data Phenomenon25 image0) 97)
	(= (data Phenomenon24 thermograph1) 158)
	(= (data Phenomenon25 thermograph1) 177)
	(= (data Phenomenon24 infrared3) 168)
	(= (data Phenomenon25 infrared3) 38)
	(= (data Phenomenon24 infrared4) 133)
	(= (data Phenomenon25 infrared4) 249)
	...
	(= (slew_time Star23 GroundStation0) 25.65)
	(= (slew_time GroundStation0 Star23) 25.65)
	(= (slew_time Star23 GroundStation1) 20.26)
	(= (slew_time GroundStation1 Star23) 20.26)
	(= (slew_time Star23 GroundStation2) 18.23)
	(= (slew_time GroundStation2 Star23) 18.23)
	(= (slew_time Star23 Star3) 41.2)
	(= (slew_time Star3 Star23) 41.2)
	(= (slew_time Star23 Star4) 16.1)
	(= (slew_time Star4 Star23) 16.1)
	(= (slew_time Star23 GroundStation5) 19.72)
	(= (slew_time GroundStation5 Star23) 19.72)
	(= (slew_time Star23 GroundStation6) 36.9)
	(= (slew_time GroundStation6 Star23) 36.9)
	(= (slew_time Star23 Star7) 9.299)
	(= (slew_time Star7 Star23) 9.299)
	(= (slew_time Star23 GroundStation8) 70.63)
	(= (slew_time GroundStation8 Star23) 70.63)
	(= (slew_time Star23 GroundStation9) 32.05)
	(= (slew_time GroundStation9 Star23) 32.05)
	(= (slew_time Star23 GroundStation10) 0.4589)
	(= (slew_time GroundStation10 Star23) 0.4589)
	(= (slew_time Star23 GroundStation11) 36.55)
	(= (slew_time GroundStation11 Star23) 36.55)
	(= (slew_time Star23 Star12) 34.27)
	(= (slew_time Star12 Star23) 34.27)
	(= (slew_time Star23 Star13) 13.61)
	(= (slew_time Star13 Star23) 13.61)
	(= (slew_time Star23 Star14) 10.59)
	(= (slew_time Star14 Star23) 10.59)
	(= (slew_time Star23 Star15) 18.97)
	(= (slew_time Star15 Star23) 18.97)
	(= (slew_time Star23 Star16) 59.85)
	(= (slew_time Star16 Star23) 59.85)
	(= (slew_time Star23 Star17) 24.39)
	(= (slew_time Star17 Star23) 24.39)
	(= (slew_time Star23 GroundStation18) 52.64)
	(= (slew_time GroundStation18 Star23) 52.64)
	(= (slew_time Star23 Star19) 41.79)
	(= (slew_time Star19 Star23) 41.79)
	(= (slew_time Star23 GroundStation20) 34.39)
	(= (slew_time GroundStation20 Star23) 34.39)
	(= (slew_time Star23 Star21) 13.25)
	(= (slew_time Star21 Star23) 13.25)
	(= (slew_time Star23 Star22) 67.77)
	(= (slew_time Star22 Star23) 67.77)
	...
	(= (slew_time Phenomenon24 GroundStation0) 2.864)
	(= (slew_time GroundStation0 Phenomenon24) 2.864)
	(= (slew_time Phenomenon24 GroundStation1) 1.331)
	(= (slew_time GroundStation1 Phenomenon24) 1.331)
	(= (slew_time Phenomenon24 GroundStation2) 82.66)
	(= (slew_time GroundStation2 Phenomenon24) 82.66)
	(= (slew_time Phenomenon24 Star3) 39.86)
	(= (slew_time Star3 Phenomenon24) 39.86)
	(= (slew_time Phenomenon24 Star4) 13.14)
	(= (slew_time Star4 Phenomenon24) 13.14)
	(= (slew_time Phenomenon24 GroundStation5) 14.36)
	(= (slew_time GroundStation5 Phenomenon24) 14.36)
	(= (slew_time Phenomenon24 GroundStation6) 62.97)
	(= (slew_time GroundStation6 Phenomenon24) 62.97)
	(= (slew_time Phenomenon24 Star7) 20.54)
	(= (slew_time Star7 Phenomenon24) 20.54)
	(= (slew_time Phenomenon24 GroundStation8) 89.97)
	(= (slew_time GroundStation8 Phenomenon24) 89.97)
	(= (slew_time Phenomenon24 GroundStation9) 27.69)
	(= (slew_time GroundStation9 Phenomenon24) 27.69)
	(= (slew_time Phenomenon24 GroundStation10) 33.95)
	(= (slew_time GroundStation10 Phenomenon24) 33.95)
	(= (slew_time Phenomenon24 GroundStation11) 46.32)
	(= (slew_time GroundStation11 Phenomenon24) 46.32)
	(= (slew_time Phenomenon24 Star12) 27.7)
	(= (slew_time Star12 Phenomenon24) 27.7)
	(= (slew_time Phenomenon24 Star13) 42.76)
	(= (slew_time Star13 Phenomenon24) 42.76)
	(= (slew_time Phenomenon24 Star14) 52.58)
	(= (slew_time Star14 Phenomenon24) 52.58)
	(= (slew_time Phenomenon24 Star15) 3.183)
	(= (slew_time Star15 Phenomenon24) 3.183)
	(= (slew_time Phenomenon24 Star16) 47.51)
	(= (slew_time Star16 Phenomenon24) 47.51)
	(= (slew_time Phenomenon24 Star17) 26.12)
	(= (slew_time Star17 Phenomenon24) 26.12)
	(= (slew_time Phenomenon24 GroundStation18) 57.11)
	(= (slew_time GroundStation18 Phenomenon24) 57.11)
	(= (slew_time Phenomenon24 Star19) 2.208)
	(= (slew_time Star19 Phenomenon24) 2.208)
	(= (slew_time Phenomenon24 GroundStation20) 18.37)
	(= (slew_time GroundStation20 Phenomenon24) 18.37)
	(= (slew_time Phenomenon24 Star21) 83.49)
	(= (slew_time Star21 Phenomenon24) 83.49)
	(= (slew_time Phenomenon24 Star22) 37.67)
	(= (slew_time Star22 Phenomenon24) 37.67)
	(= (slew_time Phenomenon24 Star23) 29.26)
	(= (slew_time Star23 Phenomenon24) 29.26)
	(= (slew_time Phenomenon25 GroundStation0) 47)
	(= (slew_time GroundStation0 Phenomenon25) 47)
	(= (slew_time Phenomenon25 GroundStation1) 55.8)
	(= (slew_time GroundStation1 Phenomenon25) 55.8)
	(= (slew_time Phenomenon25 GroundStation2) 84.76)
	(= (slew_time GroundStation2 Phenomenon25) 84.76)
	(= (slew_time Phenomenon25 Star3) 65.82)
	(= (slew_time Star3 Phenomenon25) 65.82)
	(= (slew_time Phenomenon25 Star4) 20.04)
	(= (slew_time Star4 Phenomenon25) 20.04)
	(= (slew_time Phenomenon25 GroundStation5) 46.38)
	(= (slew_time GroundStation5 Phenomenon25) 46.38)
	(= (slew_time Phenomenon25 GroundStation6) 1.796)
	(= (slew_time GroundStation6 Phenomenon25) 1.796)
	(= (slew_time Phenomenon25 Star7) 4.38)
	(= (slew_time Star7 Phenomenon25) 4.38)
	(= (slew_time Phenomenon25 GroundStation8) 26.16)
	(= (slew_time GroundStation8 Phenomenon25) 26.16)
	(= (slew_time Phenomenon25 GroundStation9) 23.72)
	(= (slew_time GroundStation9 Phenomenon25) 23.72)
	(= (slew_time Phenomenon25 GroundStation10) 14.98)
	(= (slew_time GroundStation10 Phenomenon25) 14.98)
	(= (slew_time Phenomenon25 GroundStation11) 36.79)
	(= (slew_time GroundStation11 Phenomenon25) 36.79)
	(= (slew_time Phenomenon25 Star12) 9.128)
	(= (slew_time Star12 Phenomenon25) 9.128)
	(= (slew_time Phenomenon25 Star13) 56.01)
	(= (slew_time Star13 Phenomenon25) 56.01)
	(= (slew_time Phenomenon25 Star14) 27.73)
	(= (slew_time Star14 Phenomenon25) 27.73)
	(= (slew_time Phenomenon25 Star15) 7.55)
	(= (slew_time Star15 Phenomenon25) 7.55)
	(= (slew_time Phenomenon25 Star16) 50.64)
	(= (slew_time Star16 Phenomenon25) 50.64)
	(= (slew_time Phenomenon25 Star17) 0.9596)
	(= (slew_time Star17 Phenomenon25) 0.9596)
	(= (slew_time Phenomenon25 GroundStation18) 54.33)
	(= (slew_time GroundStation18 Phenomenon25) 54.33)
	(= (slew_time Phenomenon25 Star19) 23.39)
	(= (slew_time Star19 Phenomenon25) 23.39)
	(= (slew_time Phenomenon25 GroundStation20) 60.86)
	(= (slew_time GroundStation20 Phenomenon25) 60.86)
	(= (slew_time Phenomenon25 Star21) 48.28)
	(= (slew_time Star21 Phenomenon25) 48.28)
	(= (slew_time Phenomenon25 Star22) 39.87)
	(= (slew_time Star22 Phenomenon25) 39.87)
	(= (slew_time Phenomenon25 Star23) 45.12)
	(= (slew_time Star23 Phenomenon25) 45.12)
	(= (slew_time Phenomenon25 Phenomenon24) 58.18)
	(= (slew_time Phenomenon24 Phenomenon25) 58.18)
	(= (data-stored) 0)
	(= (fuel-used) 0)
)
(:goal (and
